...
(function($){
    ...
    $.notifications = function(msg, options) {
		...
		var n = $( '<div class="' + settings.type + '" id="jquery-notifications-' + counter + '"><div id="n-image"></div>' + msg + '</div>').hide().appendTo("#jquery-notifications");
    ...
    $.notifications.error = function( msg, options ){
        return $.notifications( msg, $.extend( { stick: false }, options, { type : "error" }) );
    };
